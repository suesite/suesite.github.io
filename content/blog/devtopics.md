...
5. In terms of developing *with* LLMs, this is where I'm more hesitant. I'm thinking writing specifications, LLM scaffolding etc (the many and varied markdown files involved in effective deployment of this stuff). I would tend to treat this as an advanced topic, second to e.g. learning a foundation in programming with one or two existing languages. It might seem frustrating to not be leveraging recent technology straight away, but I storngly believe an upfront investment in these foundational skills will pay off in the long run. It's also difficult to establish good practice for building this way as it's so recent, and the volatility of the platforms makes these skills incredibly hard to pin down with any reliability.
