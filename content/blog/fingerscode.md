...
![Do your fingers remember how to code?](slide1.jpg)

I’m going to talk to you about developer learning in the context of AI assisted coding. You can access the deck and links at [suesmith.dev](https://www.suesmith.dev).
...
![Programming pedagogy, PRIMM Predict Run Investigate Modify Make, Remixing, Code comprehension, Learning by debugging, Semantic waves](slide22.jpg)

OK that was a bit philosophical, let's talk about something more tangible. There is a wealth of programming pedagogy that is extremely underused in industry. A lot of this is based on research carried out by the Raspberry Pi Foundation who develop models to teach schoolchildren coding skills. It's really helpful with adults too. I won’t linger on these because this is an entire talk in itself and [I already gave it a few years ago](https://developerrelations.com/developer-education/an-open-framework-for-developer-learning). But these are if anything more valuable with AI assisted coding. 
...
![Folk working at a desk and "What level of detail is detailed enough?, How active is active enough?"](slide24.jpg)
...
![AI assisted learning, Raspberry Pi Foundation "why kids still need to learn to code in the age of AI" and Dr Cat Hicks claude skills](slide26.jpg)

But there’s good news, we can use AI to enable learning. The Raspberry Pi Foundation have wholeheartedly embraced AI in their teaching resources, but in doing that they’ve [doubled down on the importance of learning to code](https://www.raspberrypi.org/blog/why-kids-still-need-to-learn-to-code-in-the-age-of-ai/). Dr Cat Hicks has created [Claude skills](https://github.com/DrCatHicks/learning-opportunities) that exemplify some of the active learning techniques I talked about here. What I’d love to see more of is breaking language model supports out of the chat or terminal and into the editing UI in IDEs, that’s what I’m working on.

!["Slower at the start, faster later, When is a tool the right tool for the job"](slide27.jpg)
...
![Where do you find value in the process rather than the outcome? suesmith.dev](slide29.jpg)
...
>
> * [generative-placeholders.stefanbohacek.com](https://generative-placeholders.stefanbohacek.com)
